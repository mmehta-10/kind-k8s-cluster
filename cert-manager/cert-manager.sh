...
mv $BASEDIR/cert-manager.yaml $BASEDIR/cert-manager-1.10.1.yaml

# Create cert-manager resources 
kubectl apply -f $BASEDIR/cert-manager-1.10.1.yaml
...
kubectl apply -f $BASEDIR/issuer.yaml
kubectl apply -f $BASEDIR/certificate.yaml
